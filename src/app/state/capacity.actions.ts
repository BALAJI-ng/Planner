...
export const loadCapacitySuccess = createAction(
  '[Capacity] Load Success',
  props<{ rows: any[] }>()
);
export const loadCapacityFailure = createAction(
  '[Capacity] Load Failure',
  props<{ error: any }>()
);

export const saveCapacity = createAction(
  '[Capacity] Save',
  props<{ rows: any[] }>()
);
export const saveCapacitySuccess = createAction('[Capacity] Save Success');
export const saveCapacityFailure = createAction(
  '[Capacity] Save Failure',
  props<{ error: any }>()
);
